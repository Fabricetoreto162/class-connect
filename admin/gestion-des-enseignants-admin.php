...
<html lang="en">
  <head>
    ...
    <title>Gestions des Enseignants</title>
...
<div class="container-fluid z-index-2">
  <div class="row  ">
    <nav id="sidebarMenu" class="col-md-3  col-lg-2 d-lg-block bg-light sidebar px-0 collapse">
      <div class="position-fixed bg-dark vh-100 pt-2 mx-0">
        <ul class="nav flex-column ul1">
          ...
          <li class="nav-item">
            <a class="nav-link text-warning mx-2 active bg-light rounded" href="gestion-des-enseignants-admin.php">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div>
            <h1 class="h2 mb-0">Enseignants</h1>
  ...
  <div class="col-md-9 ms-sm-auto w-100 col-lg-10 px-md-4 py-4"> 
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h2 class="h4">
                        <i class="fas fa-chalkboard-teacher text-primary me-2"></i> Gestion des Enseignants
                    </h2>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <button class="btn btn-sm btn-warning me-2" data-bs-toggle="modal" data-bs-target="#addTeacherModal">
                        ...
                        <div class="card stat-card shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h6 class="text-muted fw-normal">Total Enseignants</h6>
                                        <h3 class="mb-0">10</h3>
                                    </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card stat-card shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h6 class="text-muted fw-normal">Titulaires</h6>
                                        <h3 class="mb-0">05</h3>
                                    </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card stat-card shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h6 class="text-muted fw-normal">Vacataires</h6>
                                        <h3 class="mb-0">04</h3>
                                    </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card stat-card shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h6 class="text-muted fw-normal">En congé</h6>
                                        <h3 class="mb-0">01</h3>
                                    </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="#">Par Fillière</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h6 class="mb-0">Prof. Dupont</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-primary specialty-badge">Mathématiques</span>
                                        </td>
                                        <td><span class="badge bg-success">Titulaire</span></td>
                                        <td>
                                            <small class="d-block"><i class="fas fa-phone text-muted me-1"></i> 06 12 34 56 78</small>
                                        </td>
                                        <td>
                                            <small class="d-block"><i class="fas fa-envelope text-muted me-1"></i> p.dupont@ecole.edu</small>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h6 class="mb-0">Prof. Martin</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-primary specialty-badge">Physique</span>
                                        </td>
                                        <td><span class="badge bg-success">Titulaire</span></td>
                                        <td>
                                         ...
                                         <td>
                                            <small class="d-block"><i class="fas fa-envelope text-muted me-1"></i> p.martin@ecole.edu</small>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h6 class="mb-0">Prof. Legrand</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-primary specialty-badge">Informatique</span>
                                        </td>
                                        <td><span class="badge bg-info">Vacataire</span></td>
                                        <td>
                                            <small class="d-block"><i class="fas fa-phone text-muted me-1"></i> 06 34 56 78 90</small>
                                        </td>
                                         <td>
                                            <small class="d-block"><i class="fas fa-envelope text-muted me-1"></i> p.legrand@ecole.edu</small>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-primary specialty-badge">Chimie</span>
                                        </td>
                                        ...
                                        <td>
                                            <small class="d-block"><i class="fas fa-envelope text-muted me-1"></i> p.dubois@ecole.edu</small>
                                        </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="teacherDepartment" class="form-label"> Cours enseigné</label>
