...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .bulletin-printable, .bulletin-printable * {
                visibility: visible;
            }
        ...
        /* Style pour le bulletin en version PDF */
        .bulletin-pdf {
            padding: 15px;
        }
    ...
    <div class="content-wrapper col-md-9 ms-sm-auto col-lg-10 px-0">
        ...
        <main class="main-content px-md-4">
            ...
            <div class="container-fluid px-3">
                ...
                <div id="bulletin-printable" class="bulletin-printable">
                    <div class="bulletin-card">
                        ...
                        <div class="card-body bulletin-pdf">
                            <div class="table-responsive">
...
document.getElementById('print-bulletin').addEventListener('click', function() {
    ...
    const bulletinContent = document.querySelector('.bulletin-card').innerHTML;
    ...
    const printContent = `
        ...
        <html>
            <head>
                <title>Bulletin de Notes - ${document.querySelector('.bulletin-header h4').textContent}</title>
                ${styles}
            </head>
            <body>
                ${bulletinContent}
                <div style="text-align: center; margin-top: 20px; font-size: 10px; color: #666;">
                    Imprimé le ${new Date().toLocaleDateString('fr-FR')} - Class Connect
                </div>
                <script>
    ...
    // Écrire le contenu dans la fenêtre popup
    popup.document.open();
...
document.getElementById("download-pdf").addEventListener("click", function () {
    const element = document.querySelector('.bulletin-card');
    
    // Cloner l'élément pour éviter de modifier l'original
    const cloneElement = element.cloneNode(true);
    
    // Supprimer les boutons d'action du clone
    const footer = cloneElement.querySelector('.card-footer');
    if (footer) {
        footer.remove();
    }
    ...
    const options = {
        margin: 10,
        filename: 'bulletin_<?= $selected_student ? preg_replace('/[^a-zA-Z0-9]/', '_', $selected_student['etudiant']) : 'etudiant' ?>.pdf',
        image: { 
            type: 'jpeg', 
            quality: 0.98 
        },
