...
<head>
    ...
    <title>Utilisateurs - Class Connect</title>
    ...
    <style>
        ...
        .stat-admin { background: linear-gradient(135deg, #667eea, #764ba2); }
        .stat-students { background: linear-gradient(135deg, #f093fb, #f5576c); }
        ...
        .stats-btn-admin { background: linear-gradient(135deg, #667eea, #764ba2); }
        .stats-btn-students { background: linear-gradient(135deg, #f093fb, #f5576c); }
        .stats-btn-teachers { background: linear-gradient(135deg, #4facfe, #00f2fe); }
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar w-25 collapse">
        <div class="pt-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="utilisateur-admin.php">
    ...
    <div class="content-wrapper col-md-9 ms-sm-auto col-lg-10 px-0">
        ...
        <main class="main-content px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-3 mb-4 page-header px-4 mt-4">
                <div>
                    <h1 class="h2 mb-1 fw-bold text-primary">Gestion des Utilisateurs</h1>
                    <p class="text-muted mb-0">Aperçu global des utilisateurs de la plateforme</p>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h2 class="fw-bold text-dark mb-3"><?=$nombres_admin?></h2>
                                    <small class="text-muted">Gestionnaires du système</small>
                                </div>
                            ...
                            <div class="mt-4">
                                <button class="btn stats-btn stats-btn-admin w-100" data-bs-toggle="modal" data-bs-target="#adminModal">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h2 class="fw-bold text-dark mb-3"><?=$nombres_etudiant?></h2>
                                    <small class="text-muted">Apprenants de l'établissement</small>
                                </div>
                            ...
                            <div class="mt-4">
                                <button class="btn stats-btn stats-btn-students w-100" data-bs-toggle="modal" data-bs-target="#etudiantsModal">
                                    <i class="fas fa-list me-2"></i>Voir les détails
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h2 class="fw-bold text-dark mb-3"><?=$nombres_enseignant?></h2>
                                    <small class="text-muted">Corps professoral</small>
                                </div>
                            ...
                            <div class="mt-4">
                                <button class="btn stats-btn stats-btn-teachers w-100" data-bs-toggle="modal" data-bs-target="#professeursModal">
                                    <i class="fas fa-list me-2"></i>Voir les détails
                                </button>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card stat-card">
                        <div class="card-header bg-primary text-white py-3">
                            <h4 class="mb-0"><i class="fas fa-cogs me-2"></i>Actions Rapides</h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <a href="gestion-des-etudiant-admin.php" class="btn btn-outline-primary w-100 py-3">
                                        <i class="fas fa-user-plus fa-2x mb-2"></i><br>
                                        Ajouter un étudiant
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="gestion-des-enseignants-admin.php" class="btn btn-outline-success w-100 py-3">
