    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="inscription-admin.php">
                        <i class="fas fa-user-plus me-1"></i> Inscription
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="connexion-admin.php">
        ...
        <div class="success-card">
            ...
            <div class="next-steps">
                ...
                <div class="step-item">
                    ...
                    <div class="step-text">Connectez-vous à votre compte administrateur</div>
                </div>
                <div class="step-item">
                    <div class="step-number">2</div>
                    <div class="step-text">Accédez au tableau de bord d'administration</div>
                </div>
                <div class="step-item">
                    <div class="step-number">3</div>
                    <div class="step-text">Configurez les paramètres de la plateforme</div>
                </div>
                <div class="step-item">
                    <div class="step-number">4</div>
                    <div class="step-text">Gérez les utilisateurs et les cours</div>
                </div>
            </div>
            
            <p class="welcome-text">
                Vous pouvez maintenant accéder à votre espace personnel et découvrir 
                toutes les fonctionnalités de <span class="highlight">Class Connect</span> dédiées aux administrateurs.
            </p>
            
            <!-- Boutons d'action -->
            <div class="action-buttons">
                <a href="connexion-admin.php" class="btn-primary-custom">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const countdownInterval = setInterval(function() {
            ...
            if (countdown <= 0) {
                ...
                window.location.href = 'connexion-admin.php';
            }
        }, 1000);
