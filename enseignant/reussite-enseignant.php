        ...
        <div class="success-card">
            ...
            <div class="next-steps">
                ...
                <div class="step-item">
                    ...
                    <div class="step-text">Connectez-vous à votre compte enseignant</div>
                </div>
                <div class="step-item">
                    <div class="step-number">2</div>
                    <div class="step-text">Complétez votre profil enseignant</div>
                </div>
                <div class="step-item">
                    <div class="step-number">3</div>
                    <div class="step-text">Accédez à vos cours et à la gestion des étudiants</div>
                </div>
                <div class="step-item">
                    <div class="step-number">4</div>
                    <div class="step-text">Planifiez vos cours et déposez les ressources</div>
                </div>
            </div>
            
            <p class="welcome-text">
                Vous pouvez maintenant accéder à votre espace personnel et découvrir 
                toutes les fonctionnalités de <span class="highlight">Class Connect</span> dédiées aux enseignants.
            </p>
            
            <!-- Boutons d'action -->
            <div class="action-buttons">
                <a href="connexion-enseignant.php" class="btn-primary-custom">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const countdownInterval = setInterval(function() {
            ...
            if (countdown <= 0) {
                ...
                window.location.href = 'connexion-enseignant.php';
            }
        }, 1000);
