...
$requete_enseignant=$connexion_enseignant->prepare(" INSERT INTO users(Nom,Prenom,Email,Password,Role)
 VALUES(:Nom,:Prenom,:Email,:Password,:Role) ");
$requete_enseignant->bindParam(":Nom",$nom_enseignant);
$requete_enseignant->bindParam(":Prenom",$prenom_enseignant);
$requete_enseignant->bindParam(":Email",$email_enseignant);
$requete_enseignant->bindParam(":Password",$password_enseignant);
$requete_enseignant->bindParam(":Role",$role);
$requete_enseignant->execute();
...
<head>
    ...
    <link rel="stylesheet" href="inscription-enseignant.css">
    ...
    <div class="offcanvas offcanvas-end" style="width: 250px !important; height: 100vh;" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body " >
        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
          <li class="nav-item">
            <a class="nav-link   active" aria-current="page" href="inscription-enseignant.php">Inscription</a>
          </li> 
          <li class="nav-item">
            <a class="nav-link" href="connexion-enseignant.php">Connexion</a>
          </li>
...
<main class="main-content  ">
        ...
        <div class="container ">
          <div class="row d-flex justify-content-center align-item-normal">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative derriere h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style=" background-image: url(../img/enseignant.jpg);">
              </div>
            </div>
              ...
              <div class="card card-plain">
                ...
                <div class="card-footer text-center py-0 px-lg-2 px-1">
                  <p class="my-2 text-sm mx-auto">
                    ...
                    <a href="connexion-enseignant.php" class="text-warning mx-2 Connexion font-weight-bold">Connexion</a>
                  </p>
                </div>
              </div>
            </div>
    ...
    <script src="../bootstrap-5.3.7/bootstrap-5.3.7/dist/js/bootstrap.min.js"></script>
     <script src="inscription-enseignant.js"></script>   
      <script>
