...
<div class="container-fluid z-index-2">
  <div class="row  ">
      ...
      <div class="position-fixed bg-dark vh-100 pt-2 mx-0">
        <ul class="nav flex-column ul1">
         ...
         <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link active bg-light text-warning mx-2 rounded" href="cahier-texte.php">
              <i class="fa-solid fa-sack-dollar"></i>
              Cahier de texte
            </a>
          </li>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div>
            <h1 class="h2 mb-0">Cahier de texte</h1>
       ...
       <div class="card-body">
        ...
        <div class="card mt-4">
            <div class="card-header bg-secondary text-white">
                <h5 class="mb-0"><i class="fas fa-history me-2"></i>Historique des Cours</h5>
            </div>
            <div class="card-body">
                <div class="list-group">
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between">
                            <strong>Algorithmique - Structures de données</strong>
                            <span class="badge bg-success">Objectif atteint</span>
                        </div>
                        <small>12/11/2023 - 8h-10h - Salle A12</small>
                        <p class="mb-1 mt-2">Introduction aux listes chaînées et arbres binaires</p>
                    </div>
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between">
                            <strong>Programmation - POO</strong>
                            <span class="badge bg-danger">Objectif non atteint</span>
                        </div>
                        <small>10/11/2023 - 10h-12h - Labo Info</small>
                        <p class="mb-1 mt-2">Problèmes techniques avec les postes étudiants</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
        ...
        document.getElementById('form-cahier-texte').addEventListener('submit', function(e) {
            e.preventDefault();
            alert('Cours enregistré avec succès dans le cahier de texte !');
        });
    </script>
