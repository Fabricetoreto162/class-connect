...
<div class="container-fluid z-index-2">
  <div class="row  ">
    <nav id="sidebarMenu" class="col-md-3  col-lg-2 d-lg-block bg-light sidebar px-0 collapse">
      <div class="position-fixed bg-dark vh-100 pt-2 mx-0">
        <ul class="nav flex-column ul1">
          ...
          <li class="nav-item">
            <a class="nav-link active bg-light text-warning mx-2 rounded" href="emplois-du-temps.php">
             <i class="fa-solid fa-calendar-days"></i>
                Emplois du temps
            </a>
          </li>
         <li class="nav-item">
            <a class="nav-link text-warning mx-2 rounded" href="paiements.php">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div>
            <h1 class="h2 mb-0"> Mes Programes du jours</h1>
        ...
        <div class="card shadow">
            <div class="card-header bg-primary text-dark">
                <div class="d-flex justify-content-between align-items-center">
                    <h3><i class="fas fa-calendar-alt me-2"></i>Mon Emploi du Temps</h3>
                    <div>
                        <span class="badge bg-light text-dark me-2">Licence 1 Informatique</span>
                        <span class="badge bg-light text-dark">Semaine 15</span>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td>8h-10h</td>
                                <td>
                                    <div class="cours-card bg-info">
                                        <strong>Algorithmique</strong>
                                        <div>Prof. Dupont</div>
                                        <small>Salle A12</small>
                                    </div>
                                </td>
                                <td></td>
                                <td rowspan="2">
                                    <div class="cours-card bg-warning">
                                        <strong>TP Programmation</strong>
                                        <div>Prof. Martin</div>
                                        <small>Labo Informatique</small>
                                    </div>
                                </td>
                                 <td></td>
                                  <td></td>
                ...
                <div class="mt-4">
                    <h5><i class="fas fa-bookmark me-2"></i>Mes Matières</h5>
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="card bg-light">
                                <div class="card-body">
                                    <h6>Algorithmique</h6>
                                    <small class="text-muted">5 crédits</small>
                                </div>
                            </div>
                        </div>
