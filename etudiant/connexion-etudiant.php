...
if (isset($_POST["connexion"])) {
    if (!empty($_POST['email']) && !empty($_POST['password'])) {
        ...
        $connecter_etudiant = $connecter->prepare("
            SELECT * FROM `users`, `students` 
            WHERE students.student_id = users.student_id 
            AND users.email = :email
        ");
        $connecter_etudiant->bindParam(":email", $email);        
        $connecter_etudiant->execute();
        $resultat_etudiant = $connecter_etudiant->fetch();

        if ($resultat_etudiant) {
            ...
            $etudiant_info = $requete->fetch(PDO::FETCH_ASSOC);
                ...
                $_SESSION["user_id"] = $resultat_etudiant["student_id"];
                $_SESSION["email"] = $resultat_etudiant["email"];
                $_SESSION["role"] = $resultat_etudiant["role"];
                $_SESSION["first_name"] = $resultat_etudiant["first_name"];
                $_SESSION["last_name"] = $resultat_etudiant["last_name"];
                $_SESSION["matricule"] = $resultat_etudiant["matricule"];
...
<head>
    ...
    <title>Connexion Étudiant - Class Connect</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="connexion-etudiant.php">
        ...
        <div class="login-card">
            ...
            <div class="login-footer">
                <p class="mb-0">
                    ...
                    <a href="inscription-etudiant.php">Créez-en un ici</a>
                </p>
            </div>
