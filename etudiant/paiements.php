...
<html lang="fr">
  <head>
    ...
    <title>Paiements - Class Connect</title>
    ...
    <div class="content-wrapper col-md-9 ms-sm-auto col-lg-10 px-0">
        ...
        <main class="main-content px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-3 mb-4 page-header px-4 mt-4">
                <div>
                    <h1 class="h2 mb-1 fw-bold text-primary">Paiements</h1>
                    <p class="text-muted mb-0">Gestion de vos paiements de scolarité</p>
                </div>
            ...
            <div class="container-fluid px-3">
                ...
                <div class="card payment-card">
                    <div class="card-header text-center">
                        <h3 class="card-title mb-0 text-white"><i class="fas fa-money-bill-wave me-2"></i>Paiement de la Scolarité</h3>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card payment-card">
                            <div class="card-header">
                                <h5 class="card-title mb-0 text-white"><i class="fas fa-chart-line me-2"></i>Solde Actuel</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <span class="fw-semibold">Déjà payé:</span>
                        ...
                        <div class="card payment-card mt-4">
                            <div class="card-header">
                                <h5 class="card-title mb-0 text-white"><i class="fas fa-history me-2"></i>Historique des Paiements</h5>
                            </div>
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="mb-1 fw-semibold">Frais d'inscription</h6>
                                            <small class="text-muted payment-date">15/09/2023 - Mobile Money</small>
                                        </div>
                                        <span class="badge bg-success rounded-pill">+50 000 FCFA</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card payment-card">
                            <div class="card-header">
                                <h5 class="card-title mb-0 text-white"><i class="fas fa-credit-card me-2"></i>Nouveau Paiement</h5>
                            </div>
                            <div class="card-body">
                                <form id="form-paiement">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control" placeholder="+229 01 53 91 77 22">
                                    </div>
                                    <div class="d-grid">
                                        <button type="submit" class="btn user-dropdown btn-lg">
                                ...
                                <div class="mt-4 text-center">
                                    <p class="text-muted mb-2">Moyens de paiement acceptés</p>
