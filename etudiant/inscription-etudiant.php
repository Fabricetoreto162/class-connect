...
$requete_etudiant=$connexion_etudiant->prepare(" INSERT INTO users(Nom,Prenom,Email,Password,Role)
 VALUES(:Nom,:Prenom,:Email,:Password,:Role) ");
$requete_etudiant->bindParam(":Nom",$nom_etudiant);
$requete_etudiant->bindParam(":Prenom",$prenom_etudiant);
        ...
        <div class="container ">
          <div class="row d-flex justify-content-center align-item-normal">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative image-etudiant  h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url(../img/etudiant.jpg );">
              </div>
            </div>
              ...
              <div class="card card-plain">
                ...
                <div class="card-footer text-center py-0 px-lg-2 px-1">
                  <p class="my-2 text-sm mx-auto">
                    ...
                    <a href="connexion-etudiant.php" class="text-warning mx-2 Connexion font-weight-bold">Connexion</a>
                  </p>
                </div>
              </div>
            </div>
